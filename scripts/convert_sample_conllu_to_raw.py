...
def main():
    sample_data_base = Path("data_staging/my_ewt_sample_for_legacy_probe/example/data/en_ewt-ud-sample")
    files_to_convert = [
    ...
    for conllu_filename in files_to_convert:
        ...
        if conllu_filepath.exists():
            ...
            print(f"Warning: {conllu_filepath} not found, skipping raw text conversion.")
