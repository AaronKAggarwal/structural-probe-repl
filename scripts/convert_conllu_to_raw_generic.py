...
def main():
    parser = argparse.ArgumentParser(
        description="Convert CoNLL-U/CoNLL-X file to raw text, one sentence per line."
    )
    parser.add_argument(
        "input_conllu_filepath",
        type=str,
        help="Path to the input CoNLL-U/CoNLL-X file.",
    )
    parser.add_argument(
        "output_raw_text_filepath",
        type=str,
        help="Path to save the output raw text file.",
    )
