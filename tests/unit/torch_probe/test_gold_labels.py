...
import pytest
import numpy as np
from src.torch_probe.utils.gold_labels import calculate_tree_depths, calculate_tree_distances # Adjust import
...
def test_calculate_tree_distances_empty():
    ...
    assert calculate_tree_distances(head_indices).shape == (1,0) or \
           calculate_tree_distances(head_indices).shape == (0,0)