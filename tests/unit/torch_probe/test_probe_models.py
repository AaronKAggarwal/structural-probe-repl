...
import pytest
import torch
from src.torch_probe.probe_models import DistanceProbe, DepthProbe # Adjust import
...
def test_distance_probe_forward_shape(batch_size, max_seq_len, embedding_dim, probe_rank):
